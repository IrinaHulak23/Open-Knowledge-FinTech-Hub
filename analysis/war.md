...
⚔️ [Dynamic spill-over influences of FinTech innovation development on renewable energy volatility during the time of war in pandemic: A novel insight from a wavelet model](war-1.md)

⚔️ [Tail risk connectedness and portfolio management between energy tokens and FinTech stocks: evidence from quantile-based approaches](war-2.md)
